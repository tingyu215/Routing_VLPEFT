...
class COCO:
    def __init__(self, annotation_data=None, annotation_file=None):
        """
        ...
        elif annotation_data is not None:
            self.dataset = annotation_data
        else:
            raise ValueError("You should specify either annotation_file or annotation_data")
